...
db_id = '1b713214-92cb-4229-8177-9891088bc2c3'
infobase_code = None
last_event_number = 0
...
def source_conn():
    try:
        ...
        conn = sqlite3.connect('C:\\Program Files\\1cv8\\srvinfo\\reg_1541\\1b713214-92cb-4229-8177-9891088bc2c3\\1Cv8Log\\1Cv8.lgd')
